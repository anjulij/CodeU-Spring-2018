...
public class PersistentDataStore {
	...
	/**
	 * Constructs a new PersistentDataStore and sets up its state to begin
	 * loading objects from the Datastore service.
	 */
	...
	/**
	 * Loads all User objects from the Datastore service and returns them in a
	 * List.
	 *
	...
	/**
	 * Loads all Conversation objects from the Datastore service and returns
	 * them in a List.
	 *
	 * @throws PersistentDataStoreException
	 *             if an error was detected during the load from the Datastore
	...
	/**
	 * Loads all Message objects from the Datastore service and returns them in
	 * a List.
	 *
	 * @throws PersistentDataStoreException
	 *             if an error was detected during the load from the Datastore
	...
	/**
	 * Loads all Mention objects from the Datastore service and returns them in
	 * a List.
	 *
	 * @throws PersistentDataStoreException
	 *             if an error was detected during the load from the Datastore
